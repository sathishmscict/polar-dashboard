 ...
 *
 * <p>Any transformation scheme must be reversable. Implementing classes may optionally implement an
 * integrity check to further prevent modification to preference data. Implementing classes should
 * use device-specific information as a key in the obfuscation algorithm to prevent obfuscated
 * preferences from being shared among devices.
 */
