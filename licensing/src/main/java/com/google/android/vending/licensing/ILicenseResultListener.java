...
public interface ILicenseResultListener extends android.os.IInterface {
  ...
  public abstract static class Stub extends android.os.Binder
    ...
    /**
     * Cast an IBinder object into an ILicenseResultListener interface, generating a proxy if
     * needed.
     */
    public static com.google.android.vending.licensing.ILicenseResultListener asInterface(
      ...
      if (((iin != null)
          && (iin instanceof com.google.android.vending.licensing.ILicenseResultListener))) {
    ...
    private static class Proxy
      ...
      public void verifyLicense(
          int responseCode, java.lang.String signedData, java.lang.String signature)
          throws android.os.RemoteException {
